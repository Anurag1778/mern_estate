        ...
        <div className='flex flex-col flex-1 gap-4 '>
          ...
          <div className='flex gap-4 text-white'>
            ...
            <button
              ...
              className='p-3 text-white border border-green-700 bg-green-700  rounded uppercase hover:shadow-lg disabled:opacity-80'
            >
            ...
            formData.imageUrls.map((url, index) => (
              ...
              >
                ...
                <button
                  ...
                  className='p-3 text-red-700 rounded-lg uppercase hover:opacity-75 border border-white bg-red-700  text-white'>
                  Delete
                </button>
              </div>
            ))}
