        ...
        <div className='flex flex-col flex-1 gap-4'>
          ...
          <div className='flex gap-4'>
            ...
            <button
              ...
              className='p-3 text-white border bg-green-700 border-white-700 rounded uppercase hover:shadow-lg disabled:opacity-80'
            >
            ...
            formData.imageUrls.map((url, index) => (
              ...
              >
                ...
                <button
                  ...
                  className='p-3 text-white  border rounded-lg uppercase hover:opacity-75 bg-red-700'
                >
                  Delete
                </button>
              </div>
